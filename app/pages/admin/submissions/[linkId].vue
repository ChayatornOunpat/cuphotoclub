...
// One collection's pool — everything participants sent through that link.
//
// Scoped to a single link on purpose: the overview page lists collections, and
// this page does the actual work on one of them. There is no review queue here
// on purpose — nothing in the pool is public, so there is nothing to moderate
// *for*. The only decisions are consolidate (into an album), download (for
// Instagram/Facebook) and delete.
